...
!developmentChains.includes(network.name)
    ...
    : describe("Random IPFS NFT Unit Tests", function () {
          ...
          describe("Constructor", () => {
              it("sets token uris correctly", async function () {
              ...
              it("initializes the token counter correctly", async function () {
                  const token_counter = await randomIpfsNft.getTokenCounter()
                  assert.equal(token_counter.toString(), "0")
              })
          }) // END of describing the constructor
